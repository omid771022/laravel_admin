            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form">
                        ...
                        <h4> تماس با  ما </h4>
                        <p>
                    شما  می توانید  انتقادات  پیشنهادات  خود را از  طریق   فرم زیر به ما در میان بگذلرید
                        </p>
                        <form action="{{route('store.comment')}}" method="post" role="form" class="contactForm">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control   @error('email') aria-invalid @enderror "
                                       name="email" id="email"
                            ...
                            <div class="form-group">
                  <textarea class="form-control @error('comment') is-invalid @enderror" name="comment" rows="5"
                            data-rule="required"
