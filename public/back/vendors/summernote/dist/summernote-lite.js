...
(function (factory) {
  ...
  var modal = (function () {
    var Modal = function ($node, options) {
      ...
      this.show = function () {
        ...
        this.$modal.trigger('note.modal.show.blade.php');
  ...
  var ui = {
    ...
    onDialogShown: function ($dialog, handler) {
      $dialog.one('note.modal.show.blade.php', handler);
    },
  ...
  */
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.link', function () {
        return ui.button({
          ...
          tooltip: lang.link.link + representShortcut('linkDialog.show.blade.php'),
          click: context.createInvokeHandler('linkDialog.show.blade.php')
        }).render();
      });
      ...
      context.memo('button.picture', function () {
        return ui.button({
          ...
          click: context.createInvokeHandler('imageDialog.show.blade.php')
        }).render();
      });
      ...
      context.memo('button.video', function () {
        return ui.button({
          ...
          click: context.createInvokeHandler('videoDialog.show.blade.php')
        }).render();
      });
      ...
      context.memo('button.help', function () {
        return ui.button({
          ...
          click: context.createInvokeHandler('helpDialog.show.blade.php')
        }).render();
      });
    };
  ...
  var LinkDialog = function (context) {
    ...
    context.memo('help.linkDialog.show.blade.php', options.langInfo.help['linkDialog.show.blade.php']);
  };
    ...
    options: {
      ...
      keyMap: {
        pc: {
          ...
          'CTRL+K': 'linkDialog.show.blade.php'
        },
        ...
        mac: {
          ...
          'CMD+K': 'linkDialog.show.blade.php'
        }
      },
      icons: {
